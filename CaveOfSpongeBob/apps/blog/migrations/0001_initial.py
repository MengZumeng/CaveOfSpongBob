    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(default='一个后端使用Django框架，前端使用Bootstrap4搭建的个人博客网站，主要分享博主在Python学习、SEO优化、电子商务运营等方面的内容，网站所有文章都是原创。', help_text='用来作为SEO中description,长度参考SEO标准', max_length=240, verbose_name='描述')),
            ],
            options={
                'verbose_name': '分类',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img_link', models.CharField(default='https://github.com/MengZumeng', max_length=255, verbose_name='图片地址')),
                ...
                ('slug', models.SlugField(unique=True)),
                ('author', models.ForeignKey(on_delete=models.SET(''), to=settings.AUTH_USER_MODEL, verbose_name='作者')),
                ('category', models.ForeignKey(on_delete=models.SET(''), to='blog.category', verbose_name='文章分类')),
